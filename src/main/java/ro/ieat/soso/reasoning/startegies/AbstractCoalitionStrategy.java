 ...
 */
public class AbstractCoalitionStrategy {
    ...
    private final Logger LOG = Logger.getLogger(AbstractCoalitionStrategy.class.toString());

    public AbstractCoalitionStrategy(Map<Long, Long> machineMaxTaskMapping){
